                            ...
                            div { class: "flex flex-col md:flex-row gap-8 mb-8",
                                ...
                                div { class: "flex flex-col justify-end",
                                    ...
                                    div { class: "flex gap-3 mt-6",
                                        ...
                                        button { class: "px-6 py-3 rounded-full border border-zinc-700 text-zinc-400 hover:text-white hover:border-zinc-600 transition-colors flex items-center gap-2",
